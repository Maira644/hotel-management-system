...
class Cust_Win:
    def __init__(self,root):
        ...
        #====================title======================
        lbl_title=Label(self.root,text="ADD CUSTOMER DETAILS",font=("times new roman",18,"bold"),bg="black",fg="gray",bd=4,relief=RIDGE)
        ...
        #father name
        lblfname=Label(labelframeleft,font=("arial",12,"bold"),text="Father's Name:",padx=2,pady=6)
